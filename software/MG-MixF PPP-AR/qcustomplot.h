...
protected:
  ...
  //gpx
  virtual void placeTickLabelUnit(QCPPainter *painter, double position, int distanceToAxis, const QString &text, QSize *tickLabelsSize);
  //gpx
...
public:
  ...
  // Add By XYL 2020-07-30
  void setPenData(QPen pen);
  void clearPenData();
...
public:
  ...
  */
  ...
  QCPGraph *addGraph(QString name = "", QCPAxis *keyAxis=0, QCPAxis *valueAxis=0);
